...
### FIX library output :)
if(NOT ${LIBRARY_OUTPUT_PATH} STREQUAL "${LIBRARY_OUTPUT_PATH_ROOT}/libs/${ANDROID_NDK_ABI_NAME}")
	unset(LIBRARY_OUTPUT_PATH CACHE)
	set(LIBRARY_OUTPUT_PATH "${LIBRARY_OUTPUT_PATH_ROOT}/libs/${ANDROID_NDK_ABI_NAME}" CACHE PATH "path for android libs")
endif(NOT ${LIBRARY_OUTPUT_PATH} STREQUAL "${LIBRARY_OUTPUT_PATH_ROOT}/libs/${ANDROID_NDK_ABI_NAME}")
