...
void GLES2BufferData(GLenum target, GLsizeiptr size, const GLvoid* data,
                     GLenum usage) {
  auto f = std::tr1::bind(::GLES2BufferData, target, size, data, usage);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2BufferSubData(GLenum target, GLintptr offset, GLsizeiptr size,
                        const GLvoid* data) {
  auto f = std::tr1::bind(::GLES2BufferSubData, target, offset, size, data);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

GLenum GLES2CheckFramebufferStatus(GLenum target) {
  auto f = std::tr1::bind(::GLES2CheckFramebufferStatus, target);
  return furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLenumFunction(f);
}

void GLES2Clear(GLbitfield mask) {
  auto f = std::tr1::bind(::GLES2Clear, mask);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2ClearColor(GLclampf red, GLclampf green, GLclampf blue,
                     GLclampf alpha) {
  auto f = std::tr1::bind(::GLES2ClearColor, red, green, blue, alpha);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2ClearDepthf(GLclampf depth) {
  auto f = std::tr1::bind(::GLES2ClearDepthf, depth);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2ClearStencil(GLint s) {
  auto f = std::tr1::bind(::GLES2ClearStencil, s);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2ColorMask(GLboolean red, GLboolean green, GLboolean blue,
                    GLboolean alpha) {
  auto f = std::tr1::bind(::GLES2ColorMask, red, green, blue, alpha);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2CompileShader(GLuint shader) {
  auto f = std::tr1::bind(::GLES2CompileShader, shader);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2CompressedTexImage2D(GLenum target, GLint level,
                               ...
                               const GLvoid* data) {
  auto f = std::tr1::bind(::GLES2CompressedTexImage2D, target, level,
...
void GLES2CompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset,
                                  ...
                                  const GLvoid* data) {
  auto f = std::tr1::bind(::GLES2CompressedTexSubImage2D, target, level,
...
void GLES2CopyTexImage2D(GLenum target, GLint level, GLenum internalformat,
                         ...
                         GLint border) {
  auto f = std::tr1::bind(::GLES2CopyTexImage2D, target, level, internalformat,
...
void GLES2CopyTexSubImage2D(GLenum target, GLint level, GLint xoffset,
                            ...
                            GLsizei height) {
  auto f = std::tr1::bind(::GLES2CopyTexSubImage2D, target, level, xoffset,
                          yoffset, x, y, width, height);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

GLuint GLES2CreateProgram(void) {
  auto f = std::tr1::bind(::GLES2CreateProgram);
  return furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLuintFunction(f);
}

GLuint GLES2CreateShader(GLenum type) {
  auto f = std::tr1::bind(::GLES2CreateShader, type);
  return furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLuintFunction(f);
}

void GLES2CullFace(GLenum mode) {
  auto f = std::tr1::bind(::GLES2CullFace, mode);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteBuffers(GLsizei n, const GLuint* buffers) {
  auto f = std::tr1::bind(::GLES2DeleteBuffers, n, buffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteFramebuffers(GLsizei n, const GLuint* framebuffers) {
  auto f = std::tr1::bind(::GLES2DeleteFramebuffers, n, framebuffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteProgram(GLuint program) {
  auto f = std::tr1::bind(::GLES2DeleteProgram, program);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteRenderbuffers(GLsizei n, const GLuint* renderbuffers) {
  auto f = std::tr1::bind(::GLES2DeleteRenderbuffers, n, renderbuffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteShader(GLuint shader) {
  auto f = std::tr1::bind(::GLES2DeleteShader, shader);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DeleteTextures(GLsizei n, const GLuint* textures) {
  auto f = std::tr1::bind(::GLES2DeleteTextures, n, textures);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DepthFunc(GLenum func) {
  auto f = std::tr1::bind(::GLES2DepthFunc, func);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DepthMask(GLboolean flag) {
  auto f = std::tr1::bind(::GLES2DepthMask, flag);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DepthRangef(GLclampf zNear, GLclampf zFar) {
  auto f = std::tr1::bind(::GLES2DepthRangef, zNear, zFar);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DetachShader(GLuint program, GLuint shader) {
  auto f = std::tr1::bind(::GLES2DetachShader, program, shader);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2Disable(GLenum cap) {
  auto f = std::tr1::bind(::GLES2Disable, cap);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DisableVertexAttribArray(GLuint index) {
  auto f = std::tr1::bind(::GLES2DisableVertexAttribArray, index);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DrawArrays(GLenum mode, GLint first, GLsizei count) {
  auto f = std::tr1::bind(::GLES2DrawArrays, mode, first, count);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2DrawElements(GLenum mode, GLsizei count, GLenum type,
                       const GLvoid* indices) {
  auto f = std::tr1::bind(::GLES2DrawElements, mode, count, type, indices);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2Enable(GLenum cap) {
  auto f = std::tr1::bind(::GLES2Enable, cap);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2EnableVertexAttribArray(GLuint index) {
  auto f = std::tr1::bind(::GLES2EnableVertexAttribArray, index);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2Finish(void) {
  auto f = std::tr1::bind(::GLES2Finish);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2Flush(void) {
  auto f = std::tr1::bind(::GLES2Flush);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2FramebufferRenderbuffer(GLenum target, GLenum attachment,
                                  ...
                                  GLuint renderbuffer) {
  auto f = std::tr1::bind(::GLES2FramebufferRenderbuffer, target, attachment,
...
void GLES2FramebufferTexture2D(GLenum target, GLenum attachment,
  ...
  auto f = std::tr1::bind(::GLES2FramebufferTexture2D, target, attachment,
                          textarget, texture, level);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2FrontFace(GLenum mode) {
  auto f = std::tr1::bind(::GLES2FrontFace, mode);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GenBuffers(GLsizei n, GLuint* buffers) {
  auto f = std::tr1::bind(::GLES2GenBuffers, n, buffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GenerateMipmap(GLenum target) {
  auto f = std::tr1::bind(::GLES2GenerateMipmap, target);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GenFramebuffers(GLsizei n, GLuint* framebuffers) {
  auto f = std::tr1::bind(::GLES2GenFramebuffers, n, framebuffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GenRenderbuffers(GLsizei n, GLuint* renderbuffers) {
  auto f = std::tr1::bind(::GLES2GenRenderbuffers, n, renderbuffers);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GenTextures(GLsizei n, GLuint* textures) {
  auto f = std::tr1::bind(::GLES2GenTextures, n, textures);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2GetActiveAttrib(GLuint program, GLuint index, GLsizei bufsize,
                          ...
                          GLchar* name) {
  auto f = std::tr1::bind(::GLES2GetActiveAttrib, program, index, bufsize,
...
void GLES2GetActiveUniform(GLuint program, GLuint index, GLsizei bufsize,
                           GLsizei* length, GLint* size, GLenum* type,
                           GLchar* name) {
  auto f = std::tr1::bind(::GLES2GetActiveUniform, program, index, bufsize,
                          length, size, type, name);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2GetRenderbufferParameteriv(GLenum target, GLenum pname,
                                     GLint* params) {
  auto f = std::tr1::bind(::GLES2GetRenderbufferParameteriv, target, pname,
                          params);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GetShaderiv(GLuint shader, GLenum pname, GLint* params) {
  auto f = std::tr1::bind(::GLES2GetShaderiv, shader, pname, params);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2GetShaderInfoLog(GLuint shader, GLsizei bufsize, GLsizei* length,
                           GLchar* infolog) {
  auto f = std::tr1::bind(::GLES2GetShaderInfoLog, shader, bufsize, length,
                          infolog);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2GetShaderPrecisionFormat(GLenum shadertype, GLenum precisiontype,
  ...
  auto f = std::tr1::bind(::GLES2GetShaderPrecisionFormat, shadertype,
...
void GLES2GetShaderSource(GLuint shader, GLsizei bufsize, GLsizei* length,
                          GLchar* source) {
  auto f = std::tr1::bind(::GLES2GetShaderSource, shader, bufsize, length,
                          source);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

const GLubyte* GLES2GetString(GLenum name) {
  /*auto f = std::tr1::bind(::GLES2GetString, name);
...
void GLES2ShaderSource(GLuint shader, GLsizei count, const GLchar** string,
                       const GLint* length) {
  auto f = std::tr1::bind(::GLES2ShaderSource, shader, count, string, length);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilFunc(GLenum func, GLint ref, GLuint mask) {
  auto f = std::tr1::bind(::GLES2StencilFunc, func, ref, mask);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilFuncSeparate(GLenum face, GLenum func, GLint ref,
                              GLuint mask) {
  auto f = std::tr1::bind(::GLES2StencilFuncSeparate, face, func, ref, mask);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilMask(GLuint mask) {
  auto f = std::tr1::bind(::GLES2StencilMask, mask);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilMaskSeparate(GLenum face, GLuint mask) {
  auto f = std::tr1::bind(::GLES2StencilMaskSeparate, face, mask);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilOp(GLenum fail, GLenum zfail, GLenum zpass) {
  auto f = std::tr1::bind(::GLES2StencilOp, fail, zfail, zpass);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2StencilOpSeparate(GLenum face, GLenum fail, GLenum zfail,
                            GLenum zpass) {
  auto f = std::tr1::bind(::GLES2StencilOpSeparate, face, fail, zfail, zpass);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2TexImage2D(GLenum target, GLint level, GLint internalformat,
  ...
  auto f = std::tr1::bind(::GLES2TexImage2D, target, level, internalformat,
                          width, height, border, format, type, pixels);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2TexParameterf(GLenum target, GLenum pname, GLfloat param) {
  auto f = std::tr1::bind(::GLES2TexParameterf, target, pname, param);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2TexParameterfv(GLenum target, GLenum pname, const GLfloat* params) {
  auto f = std::tr1::bind(::GLES2TexParameterfv, target, pname, params);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2TexParameteri(GLenum target, GLenum pname, GLint param) {
  auto f = std::tr1::bind(::GLES2TexParameteri, target, pname, param);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2TexParameteriv(GLenum target, GLenum pname, const GLint* params) {
  auto f = std::tr1::bind(::GLES2TexParameteriv, target, pname, params);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2UniformMatrix3fv(GLint location, GLsizei count, GLboolean transpose,
                           const GLfloat* value) {
  auto f = std::tr1::bind(::GLES2UniformMatrix3fv, location, count, transpose,
                          value);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2UniformMatrix4fv(GLint location, GLsizei count, GLboolean transpose,
                           const GLfloat* value) {
  auto f = std::tr1::bind(::GLES2UniformMatrix4fv, location, count, transpose,
                          value);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2UseProgram(GLuint program) {
  auto f = std::tr1::bind(::GLES2UseProgram, program);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2ValidateProgram(GLuint program) {
  auto f = std::tr1::bind(::GLES2ValidateProgram, program);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib1f(GLuint indx, GLfloat x) {
  auto f = std::tr1::bind(::GLES2VertexAttrib1f, indx, x);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib1fv(GLuint indx, const GLfloat* values) {
  auto f = std::tr1::bind(::GLES2VertexAttrib1fv, indx, values);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib2f(GLuint indx, GLfloat x, GLfloat y) {
  auto f = std::tr1::bind(::GLES2VertexAttrib2f, indx, x, y);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib2fv(GLuint indx, const GLfloat* values) {
  auto f = std::tr1::bind(::GLES2VertexAttrib2fv, indx, values);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib3f(GLuint indx, GLfloat x, GLfloat y, GLfloat z) {
  auto f = std::tr1::bind(::GLES2VertexAttrib3f, indx, x, y, z);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib3fv(GLuint indx, const GLfloat* values) {
  auto f = std::tr1::bind(::GLES2VertexAttrib3fv, indx, values);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib4f(GLuint indx, GLfloat x, GLfloat y, GLfloat z,
                         GLfloat w) {
  auto f = std::tr1::bind(::GLES2VertexAttrib4f, indx, x, y, z, w);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2VertexAttrib4fv(GLuint indx, const GLfloat* values) {
  auto f = std::tr1::bind(::GLES2VertexAttrib4fv, indx, values);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
...
void GLES2VertexAttribPointer(GLuint indx, GLint size, GLenum type,
                              ...
                              const GLvoid* ptr) {
  auto f = std::tr1::bind(::GLES2VertexAttribPointer, indx, size, type,
                          normalized, stride, ptr);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}

void GLES2Viewport(GLint x, GLint y, GLsizei width, GLsizei height) {
  auto f = std::tr1::bind(::GLES2Viewport, x, y, width, height);
  furai::NaClFurai::NACL_MAIN_THREAD_CALLS->CallGLvoidFunction(f);
}
